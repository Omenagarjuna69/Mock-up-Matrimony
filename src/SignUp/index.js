        ...
        <div className="signUpBackground">
          <div>
            ...
            <p className="signUpPara">
              Create a account or <Link to="/">Login in</Link>
            </p>
          </div>
            ...
            <div className="signUpWrap">
              <div className="wrapEle">
                <div className="divBack">
                  <lable className="labelEle">First Name</lable>
                ...
                <div className="divBack">
                  <lable className="labelEle">Middle Name</lable>
                  <div className="divEle1">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="16"
                ...
                <hr style="width:80%;text-align:left;margin-left:15" />
                <div className="divBack">
                  <lable className="labelEle">Last Name</lable>
                  <div className="divEle1">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="16"
                ...
                <div className="divBack">
                  <lable className="labelEle" forHtml="Uname">
                    Email
                  </lable>
                  <div className="divEle1">
                    <svg
                ...
                <hr Style="width:80%;text-align:left;margin-left:15" />
                <div className="divBack">
                  <label className="labelEle" forHtml="gender">
                    Choose Your Gender
                  </label>
                  <div className="divEle1">
                    <svg
                ...
                <div className="divBack">
                  ...
                  <div className="divEle1">
                    ...
                    <textarea
                      value={permanentresisdence}
                      onChange={this.permanentresisdence}
              ...
              <div>
                <div className="divBack">
                  ...
                  <div className="divEle1">
                    ...
                    <textarea
                      value={currentresisdence}
                      onChange={this.currentresisdence}
                ...
                <div className="divBack">
                  <lable className="labelEle" forHtml="Uname">
                    Working Company or Organisation
                  </lable>
                  <div className="divEle1">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                    ...
                    <input
                      ...
                      placeholder="Enter Your Working Company or Organisation"
                      id="Uname"
                      type="text"
                    />
                  </div>
                ...
                <div className="divBack">
                  ...
                  <div className="divEle1">
                    ...
                    <input
                      ...
                      placeholder="Enter Your Net Salary/CTC"
                      id="Uname"
                      type="text"
                    />
                  </div>
                ...
                <div className="divBack">
                  ...
                  <div className="divEle1">
                    ...
                    <input
                      value={casteperference}
                      onChange={this.casteperference}
                      placeholder="Any Caste Preference"
                      id="Uname"
                      type="text"
                    />
                  </div>
                ...
                <div className="divBack">
                  ...
                  <div className="divEle1">
                    ...
                    <input
                      value={ageprefernce}
                      onChange={this.ageperference}
                      placeholder="Any Age Preference"
                      id="Uname"
                      type="text"
                    />
                  </div>
                ...
                <div className="divBack">
                  ...
                  <div className="divEle1">
                    ...
                    <input
                      value={partnerperference}
                      onChange={this.partnerperference}
                      placeholder="Any Partner Salary Preference"
                      id="Uname"
                      type="text"
                    />
                  </div>
